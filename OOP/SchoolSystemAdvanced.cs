...
namespace SchoolSystemApp
{
    class Student
    {
        ...
        // Boş constructor tetiklendiğinde bölümü rastgele seçiyoruz
        public Student()
        {
        ...
        // --- RASTGELE BÖLÜM ÜRETEN YARDIMCI METOT ---
        private string GetRandomDepartment()
        {
            // Mühendislik dışında 3 popüler bölüm daha ekledik
            string[] departments = { "Engineering", "Cloud Computing", "Business Administration", "Architecture" };
            Random rnd = new Random();
            int index = rnd.Next(departments.Length); 
    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            // Admin mezunumuz sabit olarak Computer Science bölümünde kalmaya devam ediyor
            ...
            // Döngüyle yeni öğrenciler oluşturuyoruz. 
            // New Student() dendiği an arka planda GetRandomDepartment() sayesinde rastgele bölüm atanıyor.
            ...
            foreach (var s in studentList)
            {
                if (s is Graduate g)
                {
                    Console.WriteLine("Name: " + g.FullName.PadRight(20) + 
                                      " | ID: " + g.StudentId + 
                                      " | Dept: " + g.Department.PadRight(22) + 
                                      " [Graduate - " + g.DegreeType + "]");
                }
                else
                {
                    Console.WriteLine("Name: " + s.FullName.PadRight(20) + 
                                      " | ID: " + s.StudentId + 
                                      " | Dept: " + s.Department);
                }
            }
